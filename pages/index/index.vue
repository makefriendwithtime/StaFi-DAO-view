<template>
	<scroll-view class="page-view" scroll-y>
		...
		<view class="main-card">
			...
			<view class="card-text"><image src="../../static/logos.png" class="xzs"></image></view>
		</view>
		<!--按钮-->
		...
		<view class="other-info">
			...
			<view class="oi-main">
				...
				<!--底部LOGO-->
				<view class="f-logo"><image src="../../static/logo.png" mode="widthFix"></image></view>
			</view>
		</view>
...
<style>
	...
	.s-one {
		background: linear-gradient(170deg, rgba(9, 9, 9, 0.79) 9.75%, rgba(255, 0, 0, 0.79) 95.05%), rgb(204, 39, 39);
	...
	.s-two {
		background: linear-gradient(170deg, rgba(9, 9, 9, 0.79) 9.75%, rgba(86, 18, 91, 0.79) 95.05%), #DC27F4;
	...
	.s-three {
		background: linear-gradient(170deg, rgba(9, 9, 9, 0.79) 9.75%, #f3b013 95.05%), #F5EE3E;
		/* background-image: url(../../static/j3.png) !important; */
	}

	.s-four {
		background: linear-gradient(170deg, rgba(9, 9, 9, 0.79) 9.75%, rgba(60, 83, 95, 0.8) 55.05%), #eee;
		/* background-image: url(../../static/j4.png) !important; */
	}

	.s-five {
		background: linear-gradient(170deg, rgba(9, 9, 9, 0.79) 9.75%, rgba(85, 9, 9, .5) 95.05%), rgb(255, 201, 63);
	...
	.s-six {
		background: linear-gradient(170deg, rgba(9, 9, 9, 0.79) 9.75%, #666 95.05%), #333;
	...
	.showm {
		animation: upup .5s ease-in 0s 1 alternate forwards;
		-webkit-animation: upup .5s ease-in 0s 1 alternate forwards;
		display: block;
	}
	...
	.showms {
		animation: dodo .5s ease-in 0s 1 alternate forwards;
		-webkit-animation: dodo .5s ease-in 0s 1 alternate forwards;
	}
 ...
 */
	...
	.dc-one:nth-child(2n){ float:right}
	.dc-one text {
		display: block;
		font-size: 16px;
		color: #ADEAFB
	...
	.oi-box{width: 100%; height: auto; overflow: hidden;}
	.oi-box text{ font-size: 14px; font-weight: bold; color:#88D4FF; margin-bottom: 15px;}
	.oi-boxs{width: 100%; height: auto; overflow: hidden;}
	.oi-boxs>view{width: 50%; float:left; padding: 12px 0;}
	.oi-boxs>view label{display: block;width: 10vw; height: 10vw; border-radius: 10px;background:#132154; border: solid .5px rgba(255,255,255,.1); text-align: center; line-height: 10vw; float:left}
	.oi-boxs>view label text{color:rgba(255,255,255,.8); font-size: 20px;}
	.oi-boxs>view b{display: block;float:left; font-weight: normal; color:#88D4FF; line-height: 10vw; padding-left: 5px;}
	.f-logo{width: 100%; height: auto; overflow: hidden;}
	.f-logo image{display: block;width: 50%; height: auto; margin: auto; margin-top: 60px;}
</style>
